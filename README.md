...
![png](https://github.com/MariaLT/Final-Project-Java/blob/main/diagramaCasosDeUso.png)
...
VALUES 
    (9788445009598, 'El Señor de los Anillos nº 01/03 La Comunidad del Anillo', 'J.R.R. Tolkien', 'Fantasía épica',
...
VALUES ('estudiante', '$2a$10$vf4cAtFPZf3IEeHxJeCwzeFdozEyiFKgPN2viPY6Crk1qL4HZqnjm'), /*La contraseña equivale a "probando"*/
       ('admin','$2a$10$vf4cAtFPZf3IEeHxJeCwzeFdozEyiFKgPN2viPY6Crk1qL4HZqnjm' ); /*La contraseña equivale a "probando"*/
...
### Microservicios
Ejecutar en esten orden:

* config-service
* eureka-service
* proxy-books-service
* proxy-loaned-book-service
* edege service
